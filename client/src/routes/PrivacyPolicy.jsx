  ...
  return (
    <>
      ...
      <Text style={{ margin: "2rem" }} ta="justify">
        At Haribon E-Wall, we are committed to protecting your privacy and
        ...
        to us through the Grievance Forum. Please read this policy carefully to
      ...
      <Text style={{ margin: "2rem", marginTop: "1rem" }} ta="justify">
        We may collect personal information from you when you register your
        account and submit a grievance through the Forum. This information
        includes email, name, birthday, college, and program. We will use this
        information solely for the purpose of addressing and resolving your
        grievance.
      </Text>
      <Text style={{ marginLeft: "2rem" }} fw="bold">
        1.2 Log Data
      ...
      <Text style={{ margin: "2rem", marginTop: "1rem" }} ta="justify">
        When you access the Web Grievance System, our servers may automatically
        collect certain information known as log data. This data may include
        your IP address, browser type, referring/exit pages, and other
        information about your interaction with the system. We use this to
        provide accessibility and functionality of the forum.
      </Text>
      ...
      <Text style={{ margin: "2rem", marginTop: "1rem" }} ta="justify">
        We may engage trusted third-party service providers (Microsoft) to
        assist us in operating the Grievance Forum and providing the necessary
        services. These service providers will have access to your personal
      ...
      <Text style={{ margin: "2rem", marginTop: "1rem" }} ta="justify">
        ...
        industry-standard measures to protect it against unauthorized access,
      ...
      <Text style={{ margin: "2rem", marginTop: "1rem" }} ta="justify">
        ...
        law. Afterward, we will securely dispose of or anonymize your
        information to prevent unauthorized access or use.
      </Text>
      ...
      <Text style={{ margin: "2rem", marginTop: "1rem" }} ta="justify">
        ...
        have any questions or concerns about your personal information, please
      ...
      <Accordion style={{ margin: "2rem", marginTop: "1rem" }}>
        <Accordion.Item value="q1">
          ...
          <Accordion.Panel>
            A: We will use your personal information solely for the purpose of
            addressing and resolving your grievance submitted through the Forum
          </Accordion.Panel>
        </Accordion.Item>
        ...
        <Accordion.Item value="q2">
          ...
          <Accordion.Panel>
            A: We may engage trusted third-party service providers to assist us
            in operating the Grievance Forum. These service providers will have
        ...
        <Accordion.Item value="q3">
          ...
          <Accordion.Panel>
            A: We will retain your personal information for as long as necessary
            to fulfill the purposes outlined in this privacy policy, or as
            required by law. Afterward, we will securely dispose of or anonymize
            your information to prevent unauthorized access or use.
          </Accordion.Panel>
        </Accordion.Item>
        ...
        <Accordion.Item value="q4">
          ...
          <Accordion.Panel>
            A: We take the security of your personal information seriously and
        ...
        <Accordion.Item value="q5">
          <Accordion.Control>
            Q: How can I be sure that my identity will remain anonymous
            throughout the grievance process?
          </Accordion.Control>
          <Accordion.Panel>
            A: We have implemented robust technical and procedural measures to
            maintain the anonymity of individuals using the system. Your
            personal information will be securely stored and accessible only to
            authorized personnel involved in addressing and resolving the
            grievance.
          </Accordion.Panel>
        </Accordion.Item>
        ...
        <Accordion.Item value="q6">
          <Accordion.Control>
            Q: What measures are in place to protect against the accidental
            disclosure of my identity?
          </Accordion.Control>
          <Accordion.Panel>
            A: We have implemented strict access controls and security protocols
            to prevent accidental disclosure of your identity. Only authorized
            personnel who are directly involved in the grievance resolution
            process will have access to the information provided, and they are
